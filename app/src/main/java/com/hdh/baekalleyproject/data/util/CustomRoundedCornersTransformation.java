...
public class CustomRoundedCornersTransformation implements Transformation<Bitmap> {
    ...
    private static final String ID = "co.codebrick.shopsta.util.CustomRoundedCornersTransformation";
    private static final byte[] ID_BYTES = ID.getBytes(CHARSET);

    public CustomRoundedCornersTransformation(Context context, int radius, int margin) {
        this(context, radius, margin, CornerType.ALL);
    }

    public CustomRoundedCornersTransformation(BitmapPool pool, int radius, int margin) {
    ...
    public boolean equals(Object o) {
        return (o instanceof CustomRoundedCornersTransformation) && ((CustomRoundedCornersTransformation) o).mRadius == mRadius;
    }
